"""
Train misinformation detection model using adapter-based or standard transformer architectures.
Supports early stopping, gradient checkpointing, and mixed precision.
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument('--config', type=str, default='configs/misinfo_config.yaml',
